  ...
  return (
    <section className='grid grid-cols-1 lg:grid-cols-12'>
      <div className='col-span-1 lg:col-span-12'>
        <div className='bg-gradient-to-r from-[#94CECB] to-[#D1D4E9] rounded-2xl border border-gray-300 shadow-md py-6 px-4 lg:py-10 lg:px-10 lg:rounded-3xk lg:border lg:border-gray-300 lg:shadow-md lg:z-10 lg:flex lg:items-center lg:justify-around'>
