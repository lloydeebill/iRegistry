...
const ReqstCenoDeath = () => {
	const title = "Request Certificate of No Death";
	const link = "https://forms.gle/rZvJqAdmzbdMh3cS7";
		...
		<main>
			...
			<div className="mt-28 container mx-auto px-12 py-0">
				...
				<div className="bg-white p-2 rounded-2xl">
					<DisclosureButton
						question="Payment & Fees: Request of Certificate of No Death"
					...
					/>
					<DisclosureButton
						question="Requirements: Request of Certificate of No Death"
						answer="No."
					/>
				</div>
				<div>
