...
const ReqstCoM = () => {
	const title = "Request Certificate of No Marriage";
	const link = "https://forms.gle/Php4F9ZKVbRDLwbu8";
		...
		<main>
			...
			<div className="mt-28 container mx-auto px-12 py-0">
				...
				<div className="bg-white p-2 rounded-2xl">
					<DisclosureButton
						question="Payment & Fees: Request of Certificate of No Marriage"
					...
					/>
					<DisclosureButton
						question="Requirements: Request of Certificate of No Marriage"
						answer="No."
					/>
				</div>
				<div>
