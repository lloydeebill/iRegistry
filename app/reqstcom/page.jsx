...
const ReqstCoM= () => {
  const title = "Request Certificate of Marriage";
  const link = "https://forms.gle/XJNSXrmnyLWZCzRZ6";
    ...
    <main>
        ...
        <div className="mt-28 container mx-auto px-12 py-0">
            ...
            <div className="bg-white p-2 rounded-2xl">
              <DisclosureButton
            question="Payment & Fees: Request of Certificate of Marriage"
            answer="If you're unhappy with your purchase for any reason, email us within 90 days and we'll refund you in full, no questions asked."
             />
              <DisclosureButton
                question="Requirements: Request of Certificate of Marriage"
                answer="No."
             />
            </div>
